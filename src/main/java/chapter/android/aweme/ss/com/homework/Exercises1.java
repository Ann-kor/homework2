...
public class Exercises1 extends AppCompatActivity {
    ...
    private static final String ON_WINDOW = "onWindowFocus";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        content = mLifecycleDisplay.getText().toString();//当前已有的log 提取出来
    ...
    protected void onRestoreInstanceState(Bundle instance){
        ...
        content = mLifecycleDisplay.getText().toString();//当前已有的log 提取出来
        instance.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, content);
    }
